...
if __name__ == '__main__':
    ...
    # basic parameters
    parser.add_argument('--output_dir', type=str, default='./checkpoint/test', help='output directory')
    ...
    # pre_path = 'checkpoint/beamform_v1/fr/epoch_60.pth'
    # device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    # fr_module, fr_optimizer, fr_scheduler, _, _ = util.load(pre_path, 'beam', device)
    # fr_module.eval()
